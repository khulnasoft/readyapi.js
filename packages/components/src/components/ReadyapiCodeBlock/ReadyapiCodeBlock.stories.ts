...
import ReadyapiCodeBlock from './ReadyapiCodeBlock.vue'
 ...
 */
const meta = {
  component: ReadyapiCodeBlock,
  tags: ['autodocs'],
  render: (args) => ({
    components: { ReadyapiCodeBlock },
    setup() {
      return { args }
    },
    template: `<ReadyapiCodeBlock v-bind="args" />`,
  }),
} satisfies Meta<typeof ReadyapiCodeBlock>
