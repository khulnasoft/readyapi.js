...
/**
 * Creates a standard Readyapi library vite build config
 *
...
const VARS_DICT = {
  client: {
    STYLE_ID: 'readyapi-style-api-client',
    STYLE_LOADED_VAR: '--readyapi-loaded-api-client',
  },
  references: {
    STYLE_ID: 'readyapi-style-api-reference',
    STYLE_LOADED_VAR: '--readyapi-loaded-api-reference',
  },
}
        ...
        (function() {
          try {
            ...
            setTimeout(() => {
              ...
              console.warn('Auto-loading the ${app} css through js has been deprecated. Please import the css directly. Visit https://github.com/readyapi/readyapi for more info.')
            }, 0)
