...
export function ShareCommand() {
  ...
  cmd.action(async (fileArgument: string) => {
    ...
    fetch('https://sandbox.readyapi.com/api/share', {
      method: 'POST',
      headers: {
      ...
      .then((data) => {
        ...
        console.log(
          `${kleur.green('➜')} ${kleur
            ...
            `https://sandbox.readyapi.com/p/${id}`,
          )}`,
        )
        console.log(
          `${kleur.grey('➜')} ${kleur
            ...
            `https://sandbox.readyapi.com/e/${id}`,
          )}`,
        )
        console.log()
        console.log(
          `${kleur.grey('➜')} ${kleur
            ...
            `https://sandbox.readyapi.com/files/${id}/openapi.json`,
          )}`,
        )
        console.log(
          `${kleur.grey('➜')} ${kleur
            ...
            `https://sandbox.readyapi.com/files/${id}/openapi.yaml`,
          )}`,
        )
        console.log()
      })
