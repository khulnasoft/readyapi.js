...
export function ShareCommand() {
  ...
  cmd.action(async (fileArgument: string) => {
    ...
    fetch('https://sandbox.ready-api.khulnasoft.com/api/share', {
      method: 'POST',
      headers: {
      ...
      .then((data) => {
        ...
        console.log(
          `${kleur.green('➜')} ${kleur
            ...
            `https://sandbox.ready-api.khulnasoft.com/p/${id}`,
          )}`,
        )
        console.log(
          `${kleur.grey('➜')} ${kleur
            ...
            `https://sandbox.ready-api.khulnasoft.com/e/${id}`,
          )}`,
        )
        console.log()
        console.log(
          `${kleur.grey('➜')} ${kleur
            ...
            `https://sandbox.ready-api.khulnasoft.com/files/${id}/openapi.json`,
          )}`,
        )
        console.log(
          `${kleur.grey('➜')} ${kleur
            ...
            `https://sandbox.ready-api.khulnasoft.com/files/${id}/openapi.yaml`,
          )}`,
        )
        console.log()
      })
